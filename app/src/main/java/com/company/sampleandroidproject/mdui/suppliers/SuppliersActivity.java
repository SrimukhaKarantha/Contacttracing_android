 ...
 * - {@link SuppliersCreateFragment}: to create or edit a(n) Supplier,
 * - {@link SuppliersDetailFragment}: to display the details of a(n) Supplier,
 * - {@link SuppliersListFragment}: to list Suppliers.
 *
 ...
 * what to do.
 */
public class SuppliersActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<Supplier> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link SuppliersListFragment} is
     * getting instantiated (which will load {@link SuppliersDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new SuppliersListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable Supplier entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        SuppliersCreateFragment fragment = new SuppliersCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable Supplier entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new SuppliersDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new SuppliersDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable Supplier entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link SuppliersCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((SuppliersActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            SupplierViewModel viewModel = new ViewModelProvider(getActivity()).get(SupplierViewModel.class);
