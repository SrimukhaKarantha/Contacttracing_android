 ...
 * - {@link PurchaseOrderItemsCreateFragment}: to create or edit a(n) PurchaseOrderItem,
 * - {@link PurchaseOrderItemsDetailFragment}: to display the details of a(n) PurchaseOrderItem,
 * - {@link PurchaseOrderItemsListFragment}: to list PurchaseOrderItems.
 *
 ...
 * what to do.
 */
public class PurchaseOrderItemsActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<PurchaseOrderItem> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link PurchaseOrderItemsListFragment} is
     * getting instantiated (which will load {@link PurchaseOrderItemsDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new PurchaseOrderItemsListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable PurchaseOrderItem entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        PurchaseOrderItemsCreateFragment fragment = new PurchaseOrderItemsCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable PurchaseOrderItem entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new PurchaseOrderItemsDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new PurchaseOrderItemsDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable PurchaseOrderItem entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link PurchaseOrderItemsCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((PurchaseOrderItemsActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            PurchaseOrderItemViewModel viewModel = new ViewModelProvider(getActivity()).get(PurchaseOrderItemViewModel.class);
