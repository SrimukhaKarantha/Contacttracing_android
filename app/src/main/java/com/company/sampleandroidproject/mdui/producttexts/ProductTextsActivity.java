 ...
 * - {@link ProductTextsCreateFragment}: to create or edit a(n) ProductText,
 * - {@link ProductTextsDetailFragment}: to display the details of a(n) ProductText,
 * - {@link ProductTextsListFragment}: to list ProductTexts.
 *
 ...
 * what to do.
 */
public class ProductTextsActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<ProductText> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link ProductTextsListFragment} is
     * getting instantiated (which will load {@link ProductTextsDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new ProductTextsListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable ProductText entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        ProductTextsCreateFragment fragment = new ProductTextsCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable ProductText entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new ProductTextsDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new ProductTextsDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable ProductText entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link ProductTextsCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((ProductTextsActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            ProductTextViewModel viewModel = new ViewModelProvider(getActivity()).get(ProductTextViewModel.class);
