 ...
 * - {@link CustomersCreateFragment}: to create or edit a(n) Customer,
 * - {@link CustomersDetailFragment}: to display the details of a(n) Customer,
 * - {@link CustomersListFragment}: to list Customers.
 *
 ...
 * what to do.
 */
public class CustomersActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<Customer> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link CustomersListFragment} is
     * getting instantiated (which will load {@link CustomersDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new CustomersListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable Customer entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        CustomersCreateFragment fragment = new CustomersCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable Customer entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new CustomersDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new CustomersDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable Customer entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link CustomersCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((CustomersActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            CustomerViewModel viewModel = new ViewModelProvider(getActivity()).get(CustomerViewModel.class);
